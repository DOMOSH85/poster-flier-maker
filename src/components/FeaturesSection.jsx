      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-gray-100 hover:border-primary/20 hover:-translate-y-1">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl font-semibold text-secondary group-hover:text-primary transition-colors">
                  {feature.title}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-secondary-lighter leading-relaxed">
                  {feature.description}
                </CardDescription>
              </CardContent>
            </Card>
        ...
        <div className="mt-16 bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-8 md:p-12 border border-primary/20">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-secondary mb-4">
                AI-Powered Design Assistant
              </h3>
              <p className="text-secondary-lighter text-lg mb-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Badge className="bg-white text-secondary border border-gray-200">Smart Layouts</Badge>
                <Badge className="bg-white text-secondary border border-gray-200">Color Harmony</Badge>
                <Badge className="bg-white text-secondary border border-gray-200">Font Pairing</Badge>
                <Badge className="bg-white text-secondary border border-gray-200">Content Optimization</Badge>
              </div>
            </div>
            <div className="relative">
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="font-medium text-secondary">AI Suggestions</span>
                </div>
